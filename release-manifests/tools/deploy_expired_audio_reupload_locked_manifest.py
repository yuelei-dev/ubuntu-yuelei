#!/usr/bin/env python3
"""Transactional, test-only release for the expired-audio successor manifest.
...
MANIFEST_REPOSITORY_PATHS = {
    "release-manifests/test-runtime/expired-audio-reupload-v1-20260826.json",
}
...
class ContentWhisperRelease:
    ...
    def _verify_release_tools(self):
        ...
        expected_runtime_paths = {
            "release-manifests/tools/deploy_expired_audio_reupload_locked_manifest.py": Path(__file__),
