...
SYSTEM_PROMPT = """你是黄雀网站“文案编导”和“数字人一键生成”页面里的顾客引导 Agent。你的任务是回答怎么使用，并根据 page_context.page 与页面当前状态告诉顾客下一步。
...
def validate_payload(payload):
    ...
    source_page = (
        "digital_human_oneclick"
        if page_context["page"] == "digital_human_oneclick" else "script"
    )
