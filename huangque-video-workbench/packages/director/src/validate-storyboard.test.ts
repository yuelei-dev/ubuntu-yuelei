...
const project = {title: '测试', width: 1080 as const, height: 1920 as const, fps: 30 as const};
...
describe('validateStoryboard', () => {
  it('reports an avatar scene exceeding 12 seconds', () => {
    const board = {
      project,
      scenes: [{
        id: 'scene_001', order: 1, type: 'avatar' as const, purpose: 'narration', script: '你好',
  ...
  it('reports generated media requested for factual screenshots or uploads', () => {
    const board = {
      project,
      scenes: [{
        id: 'scene_001', order: 1, type: 'screenshot' as const, purpose: 'evidence', script: '产品截图',
  ...
  it('reports more than 15 seconds without a visual-type scene', () => {
    const board = {
      project,
      scenes: [
        {id: 'scene_001', order: 1, type: 'avatar' as const, purpose: 'narration', script: '第一段', durationEstimate: 8, visual: {layout: 'avatar_full', highlightWords: []}},
        {id: 'scene_002', order: 2, type: 'avatar' as const, purpose: 'narration', script: '第二段', durationEstimate: 8, visual: {layout: 'avatar_full', highlightWords: []}}
      ]
    } as Storyboard;
